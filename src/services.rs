...
use crate::{
    ...
    types::{
        CampusDualGrade, CampusDualSignupOption, CampusDualVerfahrenOption,
        CampusReminders, CampusTimelineEvent, CdAuthData, CdExamDetails,
        CdExamStats, ExamRegistrationMetadata, ExportTimelineEvent,
